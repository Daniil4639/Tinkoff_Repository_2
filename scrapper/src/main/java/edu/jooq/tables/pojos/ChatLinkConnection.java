...
public class ChatLinkConnection implements Serializable {
    ...
    public ChatLinkConnection(ChatLinkConnection value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ChatLinkConnection other = (ChatLinkConnection) obj;
        if (this.chatId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ChatLinkConnection (");
