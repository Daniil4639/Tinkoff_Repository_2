...
public class Chats extends TableImpl<ChatsRecord> {
    ...
    /**
     * The column <code>CHATS.WAIT_TRACK</code>.
     */
    public final TableField<ChatsRecord, Integer> WAIT_TRACK = createField(DSL.name("WAIT_TRACK"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>CHATS.WAIT_UNTRACK</code>.
     */
    public final TableField<ChatsRecord, Integer> WAIT_UNTRACK = createField(DSL.name("WAIT_UNTRACK"), SQLDataType.INTEGER, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super Long, ? super Integer, ? super Integer, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super Long, ? super Integer, ? super Integer, ? super OffsetDateTime, ? extends U> from) {
