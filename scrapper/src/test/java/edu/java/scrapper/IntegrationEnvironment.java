...
public abstract class IntegrationEnvironment {
    ...
    static void jdbcProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.jpa.properties.hibernate.connection.url", POSTGRES::getJdbcUrl);
        registry.add("spring.jpa.properties.hibernate.connection.username", POSTGRES::getUsername);
        registry.add("spring.jpa.properties.hibernate.connection.password", POSTGRES::getPassword);
    }
}
